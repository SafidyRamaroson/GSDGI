      ...
      <form action="" method="post" className="max-w-md py-4 px-8 w-96">
        <div className="flex flex-col">
          ...
          <input
            ...
            className="border-[1px] border-gray-400 py-2 px-4 rounded-sm mb-4 mt-2"
          />
        </div>
        <div className="flex flex-col">
        ...
        <div className="mb-4">
          ...
          <p className="text-sm">vous avez déjà un compte  ? <span className="text-sm text-green-600 cursor-pointer">  se connecter</span></p>
        </div>
        <button
          type="submit"
